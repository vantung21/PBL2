...
//     RBNode(Key k, Value v) : key(k), value(v), color(r), left(NULL), right(NULL), parent(NULL) {}
// };
...
//         // helpers
//         void rotateLeft(RBNode<Key, Value>* x);
//         void rotateRight(RBNode<Key, Value>* x);
//         void fixInsert(RBNode<Key, Value>* x);
...
//         RBNode<Key, Value>* minValueNode(RBNode<Key, Value>* node) {
//             RBNode<Key, Value>* current = node;
...
//         class iterator {
//             private:
//                 RBNode<Key, Value>* current;
//                 mymap<Key, Value>* tree;

//             public:
//                 iterator(RBNode<Key, Value>* start, mymap<Key, Value>* t) : current(start), tree(t) {}

//                 pair<const Key&, Value&> operator*() const {
//                     return pair<const Key&, Value&>{current->key, current->value};
//                 }

//                 pair<const Key&, Value&>* operator->() const {
//                     return new pair<const Key&, Value&>{current->key, current->value};
//                 }
...
//                     } else {
//                         RBNode<Key, Value>* parent = current->parent;
...
// template <typename Key, typename Value>
// void mymap<Key, Value>::clear(RBNode<Key, Value>* node) {
//     if (node != NULL) {
//         clear(node->left);
//         clear(node->right);
//         delete node;
...
// template <typename Key, typename Value>
// void mymap<Key, Value>::rotateLeft(RBNode<Key, Value>* x) {
...
// template <typename Key, typename Value>
// void mymap<Key, Value>::rotateRight(RBNode<Key, Value>* x) {
//     RBNode<Key, Value>* y = x->left;
//     x->left = y->right;
...
// template <typename Key, typename Value>
// void mymap<Key, Value>::fixInsert(RBNode<Key, Value>* x) {
//     RBNode<Key, Value>* parent = NULL;
//     RBNode<Key, Value>* grandparent = NULL;
...
//     RBNode<Key, Value>* newNode = new RBNode<Key, Value>(key, value);
//     if (root == NULL) {
//         newNode->color = b;
//         root = newNode;
//     } else {
//         RBNode<Key, Value>* current = root;
//         RBNode<Key, Value>* parent = NULL;
